...
\subsubsection{Proof of Theorem~\ref{convergence}} \label{proof_conv}
...
%and $\xi$ is a small positive real number, whose role will be specified subsequently.
...
\begin{figure}[b!]
  ...
  \centering
  \caption{Two sequences of weights in~\eqref{weight_comp} used for the estimation (panel (A)) and the resulting RMSEs (panel (B)). Low RMSEs of WNN weights arise from the high penalization on the remaining $200$ singular values, when they are compared with RMSEs of ANN weights.}
  \label{Fig5}
\end{figure}
...
\subsection{Proof of Lemma~\ref{Lemma2.3}}
...
\subsection{Proof of Lemma~\ref{Lemma2.4}}
