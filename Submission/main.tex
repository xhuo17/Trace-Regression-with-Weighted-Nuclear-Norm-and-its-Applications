...
%  \centering
%  \caption{ Two sequences of weights in~\eqref{weight_comp} used for the estimation (panel (A)) and the resulting RMSEs (panel (B)).
%  Low RMSEs of WNN weights arise from the high penalization on the remaining $200$ singular values, when they are compared with %RMSEs of ANN weights.}
%  \label{Fig5}
%\end{figure}
